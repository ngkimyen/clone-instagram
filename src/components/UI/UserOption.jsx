...
const UserOption = () => {
  ...
  const [iconDispatch = dispatch] = useContext(NavigationIconContext);
  ...
  const handleClick = () => {
    iconDispatch({type: 'SET_ACTIVE', id: 'user-avatar'})
  }

  return (
    <span className={classes.userOption}>
     <NavLink to={`/${localStorage.getItem('user')}`} className={classes.optionItem} onClick={handleClick}>
        <svg
          aria-label="Profile"
          className="_8-yf5 "
          color="#262626"
        ...
        <p className={classes.optionItemText}>Profile</p> 
      ...
      <div className={classes.optionItem}>
        ...
        <p className={classes.optionItemText}>Saved</p>
      </div>
      <div className={classes.optionItem}>
        <svg
          aria-label="Settings"
        ...
        <p className={classes.optionItemText}>Settings</p>
      </div>
      <div className={classes.optionItem}>
        <svg
        ...
        <p className={classes.optionItemText}>Switch Accounts</p>
      </div>

      <NavLink to='/' className={classes.optionItem} onClick={handleLogOut}>
        <p className={classes.optionItemText} >Log Out</p>
      </NavLink>
    </span>
  );
};
